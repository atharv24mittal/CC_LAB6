...
SUPABASE_URL = "https://wzkrqfwnxslrntvypspa.supabase.co" # Replace with your Supabase URL
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind6a3JxZndueHNscm50dnlwc3BhIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2OTA3MDUzMiwiZXhwIjoyMDg0NjQ2NTMyfQ.KSNWmX20y28CEsm2h5fyYJQlHxfUVZHK9HUNnJ1cQ1Q" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "D:\CC-Lab1 (1)\CC-Lab1\PES2UG23CS534.png"  # Replace with the local image path
image_name = "PES2UG23CS534.png"  # Desired name for the uploaded file
